...
describe('core.util', function() {
    ...
    describe('enableDeprecatedOptions(): ', function() {
        it('returns cloned object', function() {
            var options = {};
            expect(util.enableDeprecatedOptions(options)).not.toBe(options);
        });

        it('if toolbar:true, change nothing', function() {
            var options = {
                toolbar: true
            };

            expect(util.enableDeprecatedOptions(options)).toEqual(options);
        });

        it('if toolbar is empty object, all related options should be true', function() {
            var options = {
                toolbar: {}
            };
            ...
            expect(util.enableDeprecatedOptions(options)).toEqual(expected);
        });

        it('if toolbar.hasControlPanel:false, toolbar shoule be false', function() {
            var options = {
                toolbar: {
        ...
        it('if pagination option is already enabled, toolbar option should not affect it', function() {
            var options = {
                pagination: {},
                toolbar: {
                    hasPagination: false,
        ...
        it('if resizeHandle option is already enabled, toolbar option should not affect it', function() {
            var options = {
                resizeHandle: {},
                toolbar: {
                    hasPagination: false,
